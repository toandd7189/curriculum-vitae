...
<div id="<?php echo $params->get('class_suffix','')?>ja-form">
	<div class="<?php echo $params->get('class_suffix','')?>form-info">
		<p><?php echo $params->get('intro_text','Contact Us')?></p>
	</div>
		...
		<ul class="<?php echo $params->get('class_suffix','')?>form-list">
			<li class="<?php echo $params->get('class_suffix','')?>wide clearfix" id="row_name">
				<div class="<?php echo $params->get('class_suffix','')?>input-box">
					...
					<input class="inputbox" id="contact_name" type="text" name="name" value="<?php if ($name!='')echo $name; else echo ''; ?>" maxlength="60" size="40" placeholder="<?php echo $senderlabel;?>" />
				</div>
			</li>
			<li class="<?php echo $params->get('class_suffix','')?>wide clearfix" id="row_email">
				<div class="<?php echo $params->get('class_suffix','')?>input-box">
					...
					<input class="inputbox" id="contact_email" type="text" name="email" value="<?php if ($email!='')echo $email; else echo ''; ?>" maxlength="64" size="40" placeholder="<?php echo $email_label;?>" />
			...
			<li class="<?php echo $params->get('class_suffix','')?>wide clearfix" id="row_subject">
				<div class="<?php echo $params->get('class_suffix','')?>input-box">
					...
					<input class="inputbox" id="contact_subject" name="subject"  value="<?php echo @$subject?>"  size="40" placeholder="<?php echo $subject_label;?>"  />
				</div>
			</li>
			<li class="<?php echo $params->get('class_suffix','')?>wide clearfix" id="row_text">
				<div class="<?php echo $params->get('class_suffix','')?>input-box">
					...
					<textarea class="inputbox" id="contact_text" name="text" rows="3" cols="40" placeholder="<?php if($text!='') echo $text; else echo $message_label?>"></textarea>
				</div>
			</li>
			...
			<li>
				<div style="padding-top: 10px;">
					<a href="javascript:void(0)" id="ac-submit" class="btn btn-primary">
						<span class="icon icon-submit">&nbsp;</span><span><?php echo JText::_("SEND_EMAIL"); ?></span>
					</a>
				</div>
			</li>
		</ul>
