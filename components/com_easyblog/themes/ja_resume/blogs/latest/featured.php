...
<div class="eb-featured eb-responsive">
    <div id="eb-showcases" class="eb-showcases carousel slide mootools-noconflict"  data-featured-posts>
                ...
                <div class="eb-showcase">
                    <?php if ($post->image && $this->params->get('post_image', true) || (!$post->image && $this->params->get('post_image_placeholder', false) && $this->params->get('post_image', true))) { ?>
                        <?php $post->image == null ? $post->image = $post->getImage() : '' ; ?>
                            <div class="eb-showcase-thumb eb-post-thumb">
                    ...
                    <div class="eb-showcase-content row">
						<div class="showcase-info col-md-4 pull-left">
							<?php if ($this->params->get('featured_post_author_avatar', true)) { ?>
								<!--TODO: pull-left & pull-right settings for author avatar-->
								<a href="<?php echo $post->author->getProfileLink(); ?>" class="author-avatar pull-left">
									<img src="<?php echo $post->author->getAvatar();?>" class="eb-avatar" width="48" height="48" alt="<?php echo $this->html('string.escape', $post->author->getName());?>" />
								</a>
							<?php } ?>
                        ...
                        <div class="featured-detail col-md-8">
							...
							<div class="eb-showcase-more">
								...
								<a class="btn btn-primary" href="<?php echo $post->getPermalink();?>"><?php echo JText::_('COM_EASYBLOG_CONTINUE_READING');?></a>
								<?php } ?>
							</div>
						</div>
                    </div>
        ...
        <div class="eb-showcase-control btn-group">
            <a class="btn btn-sm" href="#eb-showcases" role="button" data-bp-slide="prev">
                <span class="fa fa-angle-left"></span>
            </a>
            <a class="btn btn-sm" href="#eb-showcases" role="button" data-bp-slide="next">
